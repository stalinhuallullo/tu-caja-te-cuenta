...
function F20_CUESTIONARIO()
{
	...
	this.getIntentos = function() { return  parseInt(this.configuracion.find('intentos').attr('num')); }	
	
	console.log(this.getIntentos);
	...
	this.getPreguntaFeedbackAudio=function() { return $(this.preguntas[this.numPreguntaActual]).attr("audiofeedback");}
	this.getPreguntaFeedbackNegativoAudio=function() { return $(this.preguntas[this.numPreguntaActual]).attr("audiofeedback_negativo");}
	...
	this.getRespuestaFeedbackAudio=function(n) {return this.getRespuestaAttr(n,"audiofeedback") };	
...
_init_F20_CUESTIONARIO= function (xml,cfgpregunta)
{
	...
	if(this.getIntentos() > 1) $('.acciones').append('<div class="intentos">Intentos restantes: '+ this.intentos +'</div>')
