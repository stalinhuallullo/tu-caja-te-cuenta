...
// Devuelve el nivel en el que se encuentra la página actual
...
// --------------------------------------------------------------------------------------------------------
//  Define los valores de una práctica
...
// --------------------------------------------------------------------------------------------------------
//  Recupera los valores de una práctica
...
function INDEX_ELEMENT()
{
	...
	this.audio=null		// Almacena el archivo MP3 de la página
	this.audiostart=null		// Indica si se inicia automáticamente o no el audio en cuanto esté servido.
