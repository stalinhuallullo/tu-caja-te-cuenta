...
F20_SEAT_setHTML = function(capa, htmlinf) {
...
function F20_SEAT_CUESTIONARIO()
{
	// RutaBase de los xml 
	...
	this.init=_init_F20_SEAT_CUESTIONARIO;	// Carga del xml
	...
	this.siguientePregunta=_siguientePregunta_F20_SEAT_CUESTIONARIO;					// Apunta a la siguiente pregunta												
	this.anteriorPregunta=_anteriorPregunta_F20_SEAT_CUESTIONARIO;					// Apunta a la siguiente pregunta												
...
//
_init_F20_SEAT_CUESTIONARIO= function (xml,cfgpregunta)
{
	...
	// La configuracion de aleatoriedad la obtenemos del indice del curso en su apartado configuracion
	...
	this.CFG_Aleatorio=indiceUnidad.test_aleatorias
	msg_debug("<font color='dark_orange'>Configuracion aleatoria del test obtenida de configuracion del indice "+this.CFG_Aleatorio+"</font>")
	...
	if((this.CFG_modo=="")||(this.CFG_modo==undefined))
	{
		...
		// como no le hemos indicado nada desde CFG_modo utilizamos la configuración del cuestionario
			...
			if(this.CFG_Aleatorio>0) 
			{
				...
				this.preguntas=_initPreguntasAleatorias_F20_SEAT_CUESTIONARIO(this.preguntas,$(this.xmlObj).find('preguntas').children(),this.CFG_Aleatorio)
	...
	else
	{
			...
			this.preguntas=_initCuestionarioModoCFG_F20_SEAT_CUESTIONARIO(this.preguntas,$(this.xmlObj).find('preguntas').children(),this.CFG_modo)
				//alert(" Tras funcion " + this.preguntas)
			this.numPreguntaActual=0;
			this.preguntaActual=this.preguntas[0];
...
_initCuestionarioModoCFG_F20_SEAT_CUESTIONARIO=function (vPreguntas, BancoPreguntas, CFG_modo)
{
...
_initPreguntasAleatorias_F20_SEAT_CUESTIONARIO=function (vPreguntas, BancoPreguntas, numAleatorias)
{
	//alert("aleatorizamos")
...
_siguientePregunta_F20_SEAT_CUESTIONARIO = function () 
{
...
_anteriorPregunta_F20_SEAT_CUESTIONARIO=function()
{
