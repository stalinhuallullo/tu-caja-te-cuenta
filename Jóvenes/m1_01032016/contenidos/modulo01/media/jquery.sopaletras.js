...
(function ($) {
    Sopa = function ($el, options) {
        ...
        var defaults = { palabras: [{ name: 'ESPECIAS' }, { name: 'PLUMAS' }, { name: 'SAL' }, { name: 'CEREALES' }, { name: 'CONCHAS'}], complejo: 9, vertical: 'S', onWin: "" };
        var aciertos = 0;
            ...
            if (cantidadclicks == 1) {
                ...
                if (posiciony != posiciony1) {
                    ...
                    while (true) {
                        ...
                        $tdlocal.css("background-color", "red");
                        $tdlocal.css("color", "#ffffff");
                        $tdlocal.css("font-weight", "bold");
                        $tdlocal.removeClass("noes");
