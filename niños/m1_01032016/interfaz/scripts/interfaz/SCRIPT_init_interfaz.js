...
/**
 * Funci�n que se ejecuta al cargar la p�gina por primera vez.
 */
$(document).ready(function() {
	
	// Definimos la ruta del XML que incluye la configuraci�n del m�dulo
	//unidadXML_url="contenidos//xml//indice_modulo03.xml"
	unidadXML_url="contenidos//xml//indice_" + getURLParams("SCO") + ".xml"
	 
	 // Cargamos configuraci�n en objeto indiceUnidad	 
	...
	actualizaMenu(indiceUnidad,F20_CAPA_MENU)
	 ...
	 // actualizamos el estado de las p�ginas con el valor del suspendata
...
// ============= Asignamos eventos touch a capa de contenido ===========================================
	...
	// Dependiendo de si se ha activado la portada el inicio del interfaz funcionar� de la siguiente forma:
	//
	//
	//		=> portada activada => se cargar� la portada definida en "interfaz//tema//portada.htm" . Desde ella se debe de 
	//			programar el acceso a la ultima p�gina accedida
	//
	//		=> portada desactivada => se cargar� la primera p�gina de contenido.
	//
	...
	else 
	{
		...
		msg_debug("[SCRIPT_init_interfaz] : No hay portada activada, con lo cual inicializamos la primera p�gina de contenidos")
