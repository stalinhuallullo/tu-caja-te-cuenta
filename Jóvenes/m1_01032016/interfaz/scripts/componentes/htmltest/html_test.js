...
function HTML_TEST(c,num)
{
	...
	this.MSG_sinmarcar="<h3 class='dowhat'>Debes marcar alguna de las respuestas</h3><p>Prueba de nuevo.</p>"
	this.MSG_feedOK="Correcto!!"
	this.MSG_feedMULTIOK="Correcto!!"
	this.MSG_feedKO="Incorrecto!!"
	...
	if(this.cuestionario.attr("desactivanavegacion")=="true"){
	...
	{
		var cont				
		var strRespuestaCorrecta="<p> La respuesta correcta es:</p>"		
	...
	this.actualizaInfoData=function()
	{
		...
		if(this.ejdata.getNumPreguntas()>1)
				this.numeroPregunta.html("[ Aciertos:"+ this.ACIERTOS + " / Fallos:" + this.FALLOS + 
...
//	this.getFeedbackPreguntasMarcadas=function()
	...
	this.finalizar=function()
	{
			...
			str=str + "<h3 class='testend'>Has finalizado el cuestionario:</h3>"

			str=str + "<table>"
			str=str + "<tr><td>Aciertos:</td><td> " + this.ACIERTOS+ "</td></tr>"
			str=str + "<tr><td>Fallos:</td><td> "+ this.FALLOS + "</td></tr>"
			var porcentaje = this.ACIERTOS/this.ejdata.getNumPreguntas()*100;
			str=str + "<tr><td>Puntuacion:</td><td> "+ Math.round(porcentaje) + "% </td></tr></table><br><br>"
			str=str + "<button class='btn_mensajeRepetir' >Repetir el cuestionario</button>"
